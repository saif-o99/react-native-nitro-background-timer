...
/**
 * Wraps a Swift `(_ nativeId: Double) -> Void` as a class.
...
public final class Func_void_double {
  ...
  private let closure: (_ nativeId: Double) -> Void

  public init(_ closure: @escaping (_ nativeId: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(nativeId: Double) -> Void {
    self.closure(nativeId)
  }
