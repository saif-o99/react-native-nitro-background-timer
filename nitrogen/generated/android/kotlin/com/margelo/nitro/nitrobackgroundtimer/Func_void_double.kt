...
/**
 * Represents the JavaScript callback `(nativeId: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(nativeId: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  @FastNative
  private external fun invoke_cxx(nativeId: Double): Unit
}
