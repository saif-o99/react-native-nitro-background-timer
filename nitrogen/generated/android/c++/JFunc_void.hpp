...
namespace margelo::nitro::nitrobackgroundtimer {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrobackgroundtimer/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrobackgroundtimer/Func_void_cxx;";
